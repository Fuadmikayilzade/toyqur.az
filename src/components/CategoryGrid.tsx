...
const CategoryIcon = ({ id }: { id: string }) => {
  const icons: Record<string, React.ReactElement> = {
    ...
    "kids-animator": <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="w-6 h-6"><circle cx="12" cy="8" r="4"/><path d="M6 20v-2a6 6 0 0 1 12 0v2"/><path d="M3 12c0 0 1-2 3-2s2 2 2 2M16 12c0 0 1-2 3-2s2 2 2 2"/></svg>,
